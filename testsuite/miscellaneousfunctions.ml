...
let _ =
  all (M.make_from_float (1. /. 3.)) (M.make_from_float (1. /. 10.)) 321;
  printf "\n";
  all (M.make_from_float (~-.4. /. 3.)) (M.make_from_float (1. /. 10.)) 3;
  printf "\n";
  all (M.make_from_float (1. /. 3.)) (M.make_from_float (~-.113. /. 10.)) 89045;
  printf "\n";
  all (M.make_from_float 0.1) (M.make_from_float (~-.1. /. 10.)) 808;
  printf "\n";
