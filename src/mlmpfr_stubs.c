...
void precision_in_range(value prec) {
  int p = Int_val(prec);
...
void base_in_range(value base) {
  int b = Int_val(base);

  if (b == 0 || (2 <= b && b <= 64) || (-36 <= b && b <= -2))
    return;
  else
    caml_raise_with_arg(*caml_named_value("base range exception"), Val_int(b));
}
...
void custom_finalize(value op) { mpfr_clear(MPFR_val(op)); }
...
CAMLprim value caml_mpfr_set(value rop, value op, value rnd) {
  ...
  CAMLreturn(val_ter(mpfr_set(MPFR_val(rop), MPFR_val2(op), rnd_val_opt(rnd))));
}
...
CAMLprim value caml_mpfr_set_d(value rop, value op, value rnd) {
  CAMLparam3(rop, op, rnd);
  CAMLreturn(val_ter(mpfr_set_d(MPFR_val(rop), DBL_val(op), rnd_val_opt(rnd))));
}
...
CAMLprim value caml_mpfr_init_set_mpfr(value prec, value rnd, value op) {
...
CAMLprim value caml_mpfr_init_set_si(value prec, value rnd, value op) {
  CAMLparam3(prec, rnd, op);
  CAMLlocal3(rop, ter, sval);
...
CAMLprim value caml_mpfr_init_set_d(value prec, value rnd, value op) {
  CAMLparam3(prec, rnd, op);
  CAMLlocal3(rop, ter, sval);
...
CAMLprim value caml_mpfr_init_set_str(value prec, value rnd, value base,
                                      value str) {
...
CAMLprim value caml_mpfr_get_d(value rnd, value op) {
  CAMLparam2(op, rnd);
  CAMLreturn(caml_copy_double(mpfr_get_d(MPFR_val2(op), rnd_val_opt(rnd))));
}

CAMLprim value caml_mpfr_get_si(value rnd, value op) {
  CAMLparam2(op, rnd);
  CAMLreturn(Val_int(mpfr_get_si(MPFR_val2(op), rnd_val_opt(rnd))));
}

CAMLprim value caml_mpfr_get_d_2exp(value rnd, value op) {
  CAMLparam2(op, rnd);
  mpfr_exp_t exp;
  double dv;
...
CAMLprim value caml_mpfr_frexp(value rnd, value prec, value op) {
  CAMLparam2(op, rnd);
  CAMLlocal1(rop);
  mpfr_exp_t exp;
  int ter;
...
CAMLprim value caml_mpfr_get_str(value rnd, value base, value n, value op) {
  ...
  ret = mpfr_get_str(NULL, &expptr, b, size, MPFR_val2(op), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_get_str_ndigits(value base, value prec) {
  CAMLparam2(prec, base);
  CAMLreturn(
      Val_int(mpfr_get_str_ndigits(Int_val(base), (mpfr_prec_t)Int_val(prec))));
}

CAMLprim value caml_mpfr_fits_sint_p(value rnd, value op) {
  CAMLparam2(op, rnd);
...
CAMLprim value caml_mpfr_add(value rnd, value prec, value op1, value op2)
...
CAMLprim value caml_mpfr_add_d(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_add_d(MPFR_val(rop), MPFR_val2(op1), DBL_val(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_d_sub(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_d_sub(MPFR_val(rop), DBL_val(op1), MPFR_val2(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_sub_d(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_sub_d(MPFR_val(rop), MPFR_val2(op1), DBL_val(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_mul_d(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_mul_d(MPFR_val(rop), MPFR_val2(op1), DBL_val(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_d_div(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_d_div(MPFR_val(rop), DBL_val(op1), MPFR_val2(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_div_d(value rnd, value prec, value op1, value op2) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_div_d(MPFR_val(rop), MPFR_val2(op1), DBL_val(op2), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_cmpabs_ui(value op1, value op2) {
  CAMLparam2(op1, op2);
...
CAMLprim value caml_mpfr_greaterequal_p(value op1, value op2) {
  CAMLparam2(op1, op2);
  CAMLreturn(Val_bool(mpfr_greaterequal_p(MPFR_val2(op1), MPFR_val2(op2))));
}
...
CAMLprim value caml_mpfr_total_order_p(value op1, value op2) {
  CAMLparam2(op1, op2);
...
CAMLprim value caml_mpfr_log10(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_log10);

CAMLprim value caml_mpfr_exp(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_exp);

CAMLprim value caml_mpfr_exp2(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_exp2);

CAMLprim value caml_mpfr_exp10(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_exp10);

CAMLprim value caml_mpfr_sin(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_sin);

CAMLprim value caml_mpfr_cos(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_cos);

CAMLprim value caml_mpfr_tan(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_tan);

CAMLprim value caml_mpfr_sinu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_sinu);

CAMLprim value caml_mpfr_cosu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_cosu);

CAMLprim value caml_mpfr_tanu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_tanu);

CAMLprim value caml_mpfr_sinpi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_sinpi);

CAMLprim value caml_mpfr_cospi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_cospi);

CAMLprim value caml_mpfr_tanpi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_tanpi);

CAMLprim value caml_mpfr_sin_cos(value rnd, value sprec, value cprec,
                                 value op) {
  CAMLparam2(op, rnd);
...
CAMLprim value caml_mpfr_csc(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_csc);

CAMLprim value caml_mpfr_cot(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_cot);

CAMLprim value caml_mpfr_acos(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_acos);

CAMLprim value caml_mpfr_asin(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_asin);

CAMLprim value caml_mpfr_atan(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_atan);

CAMLprim value caml_mpfr_acosu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_acosu);

CAMLprim value caml_mpfr_asinu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_asinu);

CAMLprim value caml_mpfr_atanu(value rnd, value prec, value op, value u)
    MPFR_REGULAR_FUNCTION1U(mpfr_atanu);

CAMLprim value caml_mpfr_acospi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_acospi);

CAMLprim value caml_mpfr_asinpi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_asinpi);

CAMLprim value caml_mpfr_atanpi(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_atanpi);

CAMLprim value caml_mpfr_atan2(value rnd, value prec, value x, value y) {
  CAMLparam3(x, y, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;

  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_atan2(MPFR_val(rop), MPFR_val2(x), MPFR_val2(y), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_atan2u(value rnd, value prec, value x, value y,
                                value u) {
...
CAMLprim value caml_mpfr_atan2pi(value rnd, value prec, value x, value y) {
  CAMLparam3(x, y, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_atan2pi(MPFR_val(rop), MPFR_val2(x), MPFR_val2(y), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_cosh(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_cosh);

CAMLprim value caml_mpfr_tanh(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_tanh);

CAMLprim value caml_mpfr_sinh_cosh(value rnd, value sprec, value cprec,
                                   value op) {
  CAMLparam2(op, rnd);
  CAMLlocal4(sop, cop, tval, sval);
  CAMLlocal2(f1, f2);
...
CAMLprim value caml_mpfr_csch(value rnd, value prec, value op)
...
CAMLprim value caml_mpfr_atanh(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_atanh);

CAMLprim value caml_mpfr_fac_ui(value rnd, value prec, value op) {
  CAMLparam2(op, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
...
CAMLprim value caml_mpfr_expm1(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_expm1);

CAMLprim value caml_mpfr_eint(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_eint);

CAMLprim value caml_mpfr_li2(value rnd, value prec, value op)
...
CAMLprim value caml_mpfr_gamma_inc(value rnd, value prec, value op1,
                                   value op2) {
...
CAMLprim value caml_mpfr_lgamma(value rnd, value prec, value op) {
  CAMLparam2(op, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
  int signp;
...
CAMLprim value caml_mpfr_erfc(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_erfc);

CAMLprim value caml_mpfr_j0(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_j0);

CAMLprim value caml_mpfr_j1(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_j1);

CAMLprim value caml_mpfr_jn(value rnd, value prec, value n, value op) {
  CAMLparam3(n, op, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;

  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_jn(MPFR_val(rop), Int_val(n), MPFR_val2(op), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_y1(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_y1);

CAMLprim value caml_mpfr_yn(value rnd, value prec, value n, value op) {
  CAMLparam3(n, op, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_yn(MPFR_val(rop), Int_val(n), MPFR_val2(op), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_fma(value rnd, value prec, value op1, value op2,
                             value op3) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_fma(MPFR_val(rop), MPFR_val2(op1), MPFR_val2(op2), MPFR_val2(op3),
                 rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_fms(value rnd, value prec, value op1, value op2,
                             value op3) {
  CAMLparam4(op1, op2, op3, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_fms(MPFR_val(rop), MPFR_val2(op1), MPFR_val2(op2), MPFR_val2(op3),
                 rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_fmma_native(value rnd, value prec, value op1,
                                     value op2, value op3, value op4) {
  CAMLparam5(op1, op2, op3, op3, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;

  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_fmma(MPFR_val(rop), MPFR_val2(op1), MPFR_val2(op2), MPFR_val2(op3),
                  MPFR_val2(op4), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_fmms_native(value rnd, value prec, value op1,
                                     value op2, value op3, value op4) {
  CAMLparam5(op1, op2, op3, op3, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter = mpfr_fmms(MPFR_val(rop), MPFR_val2(op1), MPFR_val2(op2), MPFR_val2(op3),
                  MPFR_val2(op4), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_hypot(value rnd, value prec, value op1, value op2)
    MPFR_TWO_MPFR_OPERANDS(mpfr_hypot);

CAMLprim value caml_mpfr_ai(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_ai);

CAMLprim value caml_mpfr_const_log2(value rnd, value prec) {
  CAMLparam1(rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
...
CAMLprim value caml_mpfr_dot(value rnd, value prec, value a, value b) {
  CAMLparam3(a, b, rnd);
  CAMLlocal4(rop, tmp, tval, sval);
...
CAMLprim value caml_mpfr_frac(value rnd, value prec, value op)
    MPFR_REGULAR_FUNCTION1(mpfr_frac);

CAMLprim value caml_mpfr_modf(value rnd, value iprec, value fprec, value op) {
  CAMLparam2(op, rnd);
  ...
  ret =
      mpfr_modf(MPFR_val(iop), MPFR_val(fop), MPFR_val2(op), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_fmod(value rnd, value prec, value op1, value op2)
...
CAMLprim value caml_mpfr_remainder(value rnd, value prec, value op1, value op2)
...
CAMLprim value caml_mpfr_prec_round(value rnd, value x, value prec) {
...
CAMLprim value caml_mpfr_can_round(value b, value err, value rnd1, value rnd2,
                                   value prec) {
  CAMLparam5(b, err, rnd1, rnd2, prec);
  int ret;

  ret = mpfr_can_round(MPFR_val2(b), EXP_val(err), rnd_val(rnd1), rnd_val(rnd2),
                       PREC_val(prec));
...
CAMLprim value caml_mpfr_min(value rnd, value prec, value op1, value op2)
...
CAMLprim value caml_mpfr_setsign(value rnd, value prec, value op, value s) {
  ...
  rop = caml_mpfr_init2_opt(prec);
  ter =
      mpfr_setsign(MPFR_val(rop), MPFR_val2(op), Int_val(s), rnd_val_opt(rnd));
...
CAMLprim value caml_mpfr_check_range(value rnd, value x) {
  CAMLparam2(x, rnd);
  CAMLlocal3(rop, tval, sval);
  int ter;
