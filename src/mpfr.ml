...
external tan : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float = "caml_mpfr_tan"
external sin_cos : ?rnd:mpfr_rnd_t -> ?sprec:mpfr_prec_t -> ?cprec:mpfr_prec_t ->
                   mpfr_float -> mpfr_float * mpfr_float = "caml_mpfr_sin_cos"
...
external tanh : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float = "caml_mpfr_tanh"
external sinh_cosh : ?rnd:mpfr_rnd_t -> ?sprec:mpfr_prec_t -> ?cprec:mpfr_prec_t ->
                     mpfr_float -> mpfr_float * mpfr_float = "caml_mpfr_sinh_cosh"
...
external beta : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float -> mpfr_float = "caml_mpfr_beta"
...
external fmma : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float -> mpfr_float -> mpfr_float -> mpfr_float = "caml_mpfr_fmma_bytecode" "caml_mpfr_fmma_native"
external fmms : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float -> mpfr_float -> mpfr_float -> mpfr_float = "caml_mpfr_fmms_bytecode" "caml_mpfr_fmms_native"
...
external const_log2 : ?rnd:mpfr_rnd_t -> mpfr_prec_t -> mpfr_float = "caml_mpfr_const_log2"
...
external roundeven : ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float = "caml_mpfr_roundeven"
...
external rint_roundeven : ?rnd:mpfr_rnd_t -> ?prec:mpfr_prec_t -> mpfr_float -> mpfr_float = "caml_mpfr_rint_roundeven"
