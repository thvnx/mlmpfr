...
val get_formatted_str :
  ?rnd:mpfr_rnd_t -> ?base:int -> ?size:int -> ?ktz:bool -> mpfr_float -> string
...
val add_float :
  ?rnd:mpfr_rnd_t -> ?prec:int -> mpfr_float -> float -> mpfr_float
...
val float_sub :
  ?rnd:mpfr_rnd_t -> ?prec:int -> float -> mpfr_float -> mpfr_float
...
val hypot :
  ?rnd:mpfr_rnd_t -> ?prec:int -> mpfr_float -> mpfr_float -> mpfr_float
...
val atan2u :
  ?rnd:mpfr_rnd_t -> ?prec:int -> mpfr_float -> mpfr_float -> int -> mpfr_float
...
val fmodquo :
  ?rnd:mpfr_rnd_t -> ?prec:int -> mpfr_float -> mpfr_float -> mpfr_float * int
