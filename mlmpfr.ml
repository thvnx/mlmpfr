...
external mpfr_int_pow_int : mpfr_prec_t -> int -> int -> mpfr_rnd_t -> mpfr_tv = "caml_mpfr_ui_pow_ui"
external mpfr_int_pow : mpfr_prec_t -> int -> mpfr_t -> mpfr_rnd_t -> mpfr_tv = "caml_mpfr_ui_pow"
